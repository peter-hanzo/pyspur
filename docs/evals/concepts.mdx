...
<img className="block dark:hidden" src="/images/evals/evals_flow_light.png" />
<img className="hidden dark:block" src="/images/evals/evals_flow_dark.png" />
...
Available benchmarks include tests for:
...
Now that you understand how evaluations work in PySpur:

- Explore the [available benchmarks](/evals/benchmarks) to find ones relevant to your workflows
- Learn how to [interpret evaluation results](/evals/interpreting-results) in detail
- See our [evaluation best practices](/evals/best-practices) for getting the most useful insights
