...
* Reasoning models enabled *tool calling*
* Vision models enabled *web browsing*

Unlike traditional workflow platforms that rely on external integrations, PySpur's batteries-included approach gives you more control.

### RAG Example

Imagine you spot a problematic document chunk in your vector index during run time. You can delete it directly inside PySpur.

<video
  width="100%"
  controls
>
  <source src="/images/rag1.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
