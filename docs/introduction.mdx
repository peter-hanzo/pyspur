---
title: Introduction
description: 'PySpur is a graph UI for visualizing agent trajectories in Python. AI engineers use it to inspect past runs and execute agents step-by-step.'
---
