...
Let's look at a practical example: a tool we use to summarize technical content and share it on Slack. Click the image above to see a full-size view of the tool in action, or click [here](https://assets.sevn.ai/website_assets/Slack_Summarizer.json) to download it.
...
## Bringing It All Together (1 minute)
...
Now that you've built the workflow, here are some tips to make you more efficient:

## Keyboard Shortcuts
- `⌘/CTRL + ENTER`: Run the workflow with your last test case
...
If you want to now try PySpur yourself, you can clone the workflow and try:
...
Download the workflow [here](https://assets.sevn.ai/website_assets/Slack_Summarizer.json) to get started!