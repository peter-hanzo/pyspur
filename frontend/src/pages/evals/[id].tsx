                    ...
                    <TableBody items={results.per_example_results}>
                        {(item) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    <div className="max-h-32 overflow-y-auto">{renderPrompt(item.prompt)}</div>
                                </TableCell>
                                <TableCell>{item.predicted_answer}</TableCell>
                                <TableCell>{item.ground_truth_answer}</TableCell>
                                <TableCell>
                                    <Chip color={item.is_correct ? 'success' : 'danger'} variant="flat">
                ...
                <ModalContent>
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody className="whitespace-pre-wrap overflow-y-auto">{selectedPrompt}</ModalBody>
                        </>
                    )}
                </ModalContent>
            </Modal>
