...
export const RouterNode: React.FC<RouterNodeProps> = ({
  ...
  const handleUpdateRouteMap = (
    newRouteMap: Record<string, RouteConditionGroup>,
  ) => {
    dispatch(
      updateNodeConfigOnly({
        id,
  ...
  const updateCondition = (
    ...
    const newRouteMap = {
      ...nodeConfig.route_map,
      [routeKey]: {
        conditions: nodeConfig.route_map[routeKey].conditions.map(
          (condition, i) =>
  ...
  useEffect(() => {
    ...
    if (
      !nodeConfig?.route_map ||
      Object.keys(nodeConfig.route_map).length === 0
    ) {
              ...
              {Object.entries(nodeConfig.route_map).map(([routeKey, route]) => (
                ...
                >
                  <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Select
                            ...
                            classNames={{
                              ...
                              value:
                                "whitespace-normal break-words text-foreground dark:text-foreground-100",
                              popoverContent:
                          ...
                          {!["is_empty", "is_not_empty"].includes(
                            ...
                            <Input
                              ...
                              classNames={{
                                input:
                                  "bg-background dark:bg-default-100/10 min-h-unit-12 h-auto whitespace-normal text-foreground dark:text-foreground-100",
                                inputWrapper:
                    ...
                    {/* Route Output Handle */}
                    <div
                      className={`${styles.handleRow} w-full justify-end mt-2`}
                    >
