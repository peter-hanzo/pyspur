...
def downgrade() -> None:
    ...
    sa.Column('id', sa.VARCHAR(), sa.Computed("('KB'::text || _intid)", persisted=True), autoincrement=False, nullable=False),
    ...
    sa.Column('text_processing_config', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
